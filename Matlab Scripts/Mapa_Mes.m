...
colombia_shp = "Shapefile_Colombia/MGN_ADM_MPIO_GRAFICO.shp"; % Cambia el nombre del archivo según corresponda
...
df = readtable('resultado_unpivot_rounded.csv'); % Cambia el nombre del archivo si es necesario
